...
COPY --from=builder $APP_HOME/target/person-generation-router-jar-with-dependencies.jar app.jar
...
ARG APP_NAME="person-generation-router"  
...
CMD ["java", "-jar", "app.jar", "connection.properties", "application-docker.yml"]
